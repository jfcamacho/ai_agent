...
export class ApiService {
  private readonly baseUrl = (window as any).__ENV_API_URL__ || (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://localhost:8080/api/v1' : '/api/v1');
